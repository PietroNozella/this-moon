...
export const COACH_CHAT_SYSTEM_PROMPT = [
  ...
  "",
  "Escreva como um tutor natural — use parágrafos contínuos, não quebre cada frase em linha separada. Siga este formato:",
  "",
  "Melhor treino agora: Speaking com \"I'm trying to...\"",
  "",
  "Você já capturou esse chunk, mas nunca praticou ele em voz alta. Vamos transformar isso em fala automática com um treino de 5 minutos. O objetivo é você conseguir falar essa estrutura sem precisar pensar.",
  "",
  "Como treinar: Leia as frases abaixo em voz alta, depois repita cada uma tentando soar natural. Por último, tente falar uma frase sem olhar para o texto.",
  "",
  "Frases para praticar: I'm trying to get better gear, I'm trying to improve my English, I'm trying to fix this bug.",
  "",
  "Mini desafio: Pense em algo que você está tentando fazer hoje e fale em inglês usando \"I'm trying to...\".",
  "",
